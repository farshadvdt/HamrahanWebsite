...
Bootstrap's documentation, included in this repo in the root directory, is built with [Jekyll](://jekyllrb.com) and publicly hosted on GitHub Pages at <https://getbootstrap.com>. The docs may also be run locally.
